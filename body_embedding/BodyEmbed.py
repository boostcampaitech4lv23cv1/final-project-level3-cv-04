...
def generate_body_anchor(df1, df2, group_name='aespa', meta_info=None):
    ...
    body_img_list_karina = make_body_img_list(df1, df2_karina_sorted, meta_info, img_num=10)
    # print("winter 대표 이미지 10장 뽑는 중...")
    body_img_list_winter = make_body_img_list(df1, df2_winter_sorted, meta_info, img_num=10)
    # print("ningning 대표 이미지 10장 뽑는 중...")
    body_img_list_ningning = make_body_img_list(df1, df2_ningning_sorted, meta_info, img_num=10)
    # print("giselle 대표 이미지 10장 뽑는 중...")
    body_img_list_giselle = make_body_img_list(df1, df2_giselle_sorted, meta_info, img_num=10)
